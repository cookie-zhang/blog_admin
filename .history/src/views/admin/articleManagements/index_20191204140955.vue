    ...
    <div class="tables-box">
      <el-table :data="articleLists" stripe border>
        ...
        <el-table-column label="创建时间">
          <template slot-scope="scope">{{scope.row.updateDate?moment(scope.row.createDate).format('YYYY-MM-DD HH:mm:ss') : '--'}}</template>
        </el-table-column>
        <el-table-column label="更新时间">
          <template slot-scope="scope">{{moment(scope.row.updateDatescope.row.updateDate?moment(scope.row.createDate).format('YYYY-MM-DD HH:mm:ss') : '--'}}</template>
        </el-table-column>
