    ...
    <div class="form-box">
      <el-form ref="form" :model="articleInfo" label-width="80px">
        ...
        <el-form-item label="文章介绍">
          <el-input type="textarea"  :autosize="{ minRows: 2, maxRows: 4}" v-model="articleInfo.introduce" placeholder="最多输入50个字"></el-input>
        </el-form-item>
        <el-form-item label="文章内容" >
          <div style="width:800px">
             <div class="editor" style=" width: 80%; overflow: hidden">
      ...
      this.editor.customConfig.uploadImgHooks = {
        customInsert: function (insertImg, result, editor) {
          if(result){
            ...
            //  insertImg(IMG_BASE_URL+ '/zt/cw/attachment/getFiles?id='+id);
          }
        }
      }
      this.editor.create();
