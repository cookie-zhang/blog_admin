<template>
  <div class="container container-score" style="padding: 0;">
    <div class="main-titles">每日一语管理</div>
    <!--表格-->
    <div class="createBox">
        <el-button @click="createClass" type="warning">新建一语</el-button>
      </div>
    <div class="tables-box">
        <el-table
          ...
          style="width: 100%"
        >
          <el-table-column prop="classNum" label="ID" width="100">
          ...
          <el-table-column prop="words" label="内容"  width="500">
            <template
              slot-scope="scope"
            >{{scope.row.words?scope.row.words:'--'}}</template>
          </el-table-column>
...
<script>
import { getWordsList } from '@/api/admin/words'
