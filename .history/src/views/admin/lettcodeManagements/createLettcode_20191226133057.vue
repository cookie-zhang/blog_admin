<template>
  <div class="createClass">
    <div class="main-titles">新建力扣专栏</div>
    <div class="form-box">
      <el-form ref="form" :model="articleInfo" label-width="80px">
        <el-form-item label="力扣分类">
        ...
        <el-form-item label="力扣类型">
          <el-select v-model="articleInfo.type" placeholder="力扣类型">
            <el-option
        ...
        <el-form-item label="力扣封面">
          <el-input v-model="articleInfo.coverImg" placeholder="请输入力扣封面"></el-input>
        </el-form-item>
        <el-form-item label="作者">
          <el-input v-model="articleInfo.author" placeholder="请输入作者"></el-input>
        </el-form-item>
        <el-form-item label="力扣标题">
          <el-input v-model="articleInfo.title" placeholder="请输入力扣标题"></el-input>
        </el-form-item>
        <el-form-item label="力扣介绍">
          <el-input
            type="textarea"
  ...
  methods: {
    ...
    handleSubmit() {
      if (this.id) {
        ...
        updateLettcode(this.articleInfo).then(res => {
          this.$message({
            type: 'success',
            message: '更新成功'
          });
        ...
        createLettcode(this.articleInfo).then(res => {
          this.$message({
            type: 'success',
            message: '创建成功'
          });
