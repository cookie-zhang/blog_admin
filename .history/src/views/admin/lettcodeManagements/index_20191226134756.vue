<template>
  <div class="courseList">
    ...
    <div class="tables-box">
      <el-table :data="lettcodeLists" stripe border>
        ...
        <el-table-column label="创建时间">
          <template slot-scope="scope">{{ Number(scope.row.createDate)?moment(Number(scope.row.createDate)).format('YYYY-MM-DD HH:mm:ss') : '--' }}</template>
        </el-table-column>
        <el-table-column label="更新时间">
          <template slot-scope="scope">{{ Number(scope.row.updateDate !=0 ?moment(Number(scope.row.updateDate)).format('YYYY-MM-DD HH:mm:ss') : '--' }}</template>
        </el-table-column>
